...
part 'receive_ticket_detail_data.g.dart';

@JsonSerializable()
class ReceiveTicketDetailsData {
  ...
  factory ReceiveTicketDetailsData.fromJson(Map<String, dynamic> json) =>
      _$ReceiveTicketDetailsDataFromJson(json);
  Map<String, dynamic> toJson() => _$ReceiveTicketDetailsDataToJson(this);
