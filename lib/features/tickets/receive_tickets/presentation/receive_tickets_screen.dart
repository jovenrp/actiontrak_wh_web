...
import 'package:actiontrak_wh/features/tickets/receive_tickets/presentation/receive_ticket_details.dart';
import 'package:easy_debounce/easy_debounce.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:universal_platform/universal_platform.dart';

import '../../../../application/providers/error_bloc.dart';
                        ...
                        itemBuilder: (BuildContext context, int i) {
                          ...
                          return GestureDetector(
                            ...
                            child: CustomReceiveRow(
                              ...
                              isPartial: state.receiveTickets?[i].isPartial,
                              turns: turns,
                              size: 20,
                              isOdd: i % 2 == 0 ,
                            ),
