...
class _$ShipTicketsStateImpl implements _ShipTicketsState {
  ...
  @override
  String toString() {
    return 'ShipTicketsState(isLoading: $isLoading, hasError: $hasError, shipTickets: $shipTickets, errorMessage: $errorMessage, statusCode: $statusCode)';
  }
  ...
  int get hashCode => Object.hash(
      ...
      isLoading,
      hasError,
      const DeepCollectionEquality().hash(_shipTickets),
      errorMessage,
      statusCode);
...
abstract class _ShipTicketsState implements ShipTicketsState {
  factory _ShipTicketsState(
      ...
      final List<ShipTicketsData>? shipTickets,
      final String? errorMessage,
      final String? statusCode}) = _$ShipTicketsStateImpl;
