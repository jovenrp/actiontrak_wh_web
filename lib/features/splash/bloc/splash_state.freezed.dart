...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, bool isLoggedIn, String? user});
}
...
class _$SplashStateImpl implements _SplashState {
  _$SplashStateImpl(
      {this.isLoading = false, this.isLoggedIn = false, this.user = ''});
  ...
  @override
  String toString() {
    return 'SplashState(isLoading: $isLoading, isLoggedIn: $isLoggedIn, user: $user)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, isLoggedIn, user);
...
abstract class _SplashState implements SplashState {
  factory _SplashState(
      {final bool isLoading,
      final bool isLoggedIn,
      final String? user}) = _$SplashStateImpl;
